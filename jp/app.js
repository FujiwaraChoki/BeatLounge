        ...
        fetch(`https://api.lyrics.ovh/suggest/${songTitle}`, {
            ...
            .then(data => {
                ...
                if (songs.length === 0) {
                    ...
                    notificationDiv.innerHTML = '<i class="fa-solid fa-music-note-slash"></i>曲が見つかりません！';
            ...
            .catch(err => {
                ...
                // No songs found
                notificationDiv.classList.add('alert', 'alert-danger');
                notificationDiv.innerHTML = '<i class="fa-solid fa-music-note-slash"></i>リフレッシュ実施！';
                document.body.appendChild(notificationDiv);
...
const clearSongContainer = (notification = false) => {
    ...
    if (notification) {
        ...
        notificationDiv.innerText = 'アップデート完了！';
        document.body.appendChild(notificationDiv);
