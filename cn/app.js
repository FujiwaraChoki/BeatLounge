        ...
        fetch(`https://api.lyrics.ovh/suggest/${songTitle}`, {
            ...
            .then(data => {
                ...
                if (songs.length === 0) {
                    ...
                    notificationDiv.innerHTML = '<i class="fa-solid fa-music-note-slash"></i>找不到歌曲！';
            ...
            .catch(err => {
                ...
                // No songs found
                notificationDiv.classList.add('alert', 'alert-danger');
                notificationDiv.innerHTML = '<i class="fa-solid fa-music-note-slash"></i>刷新！';
                document.body.appendChild(notificationDiv);
...
const clearSongContainer = (notification = false) => {
    ...
    if (notification) {
        ...
        notificationDiv.innerText = '更新完成！';
        document.body.appendChild(notificationDiv);
